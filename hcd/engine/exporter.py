...
from hcd.config import TASK2DATA, get_cfg
from hcd.data import build_dataloader
from hcd.data.dataset import YOLODataset
from hcd.data.utils import check_cls_dataset, check_det_dataset
from hcd.network.autobackend import check_class_names, default_class_names
from hcd.network.modules import C2f, Detect, RTDETRDecoder
from hcd.network.tasks import DetectionModel, SegmentationModel
from hcd.utils import (
    ARM64,
    DEFAULT_CFG,
    IS_JETSON,
    LINUX,
...
from hcd.utils.checks import check_imgsz, check_is_path_safe, check_requirements, check_version
from hcd.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from hcd.utils.files import file_size, spaces_in_path
from hcd.utils.ops import Profile
from hcd.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device, smart_inference_mode
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if edgetpu:
            ...
            elif self.args.batch != 1:  # see github.com/hcd/hcd/pull/13420
    ...
    def export_engine(self, prefix=colorstr("TensorRT:")):
        ...
        if int8:
            ...
            class EngineCalibrator(trt.IInt8Calibrator):
                def __init__(
                    self,
                    dataset,  # hcd.data.build.InfiniteDataLoader
                    batch: int,
                    cache: str = "",
                ) -> None:
