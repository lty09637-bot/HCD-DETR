...
HELP_MSG = \
    ...
    1. Install the hcd package:

        pip install hcd-detr
...
class IterableSimpleNamespace(SimpleNamespace):
    ...
    def __getattr__(self, attr):
        ...
        raise AttributeError(f"""
            '{name}' object has no attribute '{attr}'. This may be caused by a modified or out of date hcd
            'default.yaml' file.\nPlease update your code with 'pip install -U hcd-detr' and if necessary replace
...
class ThreadingLocked:
    ...
    Example:
        ```python
        from hcd.utils import ThreadingLocked
...
class SettingsManager(dict):
    ...
    def __init__(self, file=SETTINGS_YAML, version='0.0.4'):
        ...
        from hcd.utils.checks import check_version
        from hcd.utils.torch_utils import torch_distributed_zero_first
        ...
        with torch_distributed_zero_first(RANK):
            ...
            if not (correct_keys and correct_types and correct_version):
                LOGGER.warning(
                    ...
                    'with your settings or a recent hcd package update. '
...
def deprecation_warn(arg, new_arg, version=None):
    ...
    LOGGER.warning(f"WARNING ⚠️ '{arg}' is deprecated and will be removed in 'hcd {version}' in the future. "
