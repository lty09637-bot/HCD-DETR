...
Usage:
    from hcd.utils.benchmarks import ProfileModels, benchmark
...
from hcd.config import TASK2DATA, TASK2METRIC
from hcd.engine.exporter import export_formats
from hcd.utils import ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from hcd.utils.checks import check_requirements, check_yolo
from hcd.utils.files import file_size
...
class ProfileModels:
    ...
    Example:
        ```python
        from hcd.utils.benchmarks import ProfileModels
