...
from hcd.network.autobackend import check_class_names
from hcd.utils import (DATASETS_DIR, LOGGER, NUM_THREADS, ROOT, SETTINGS_YAML, TQDM, clean_url, colorstr,
                               emojis, yaml_load)
from hcd.utils.checks import check_file, check_font, is_ascii
from hcd.utils.downloads import download, safe_download, unzip_file
from hcd.utils.ops import segments2boxes
...
class HUBDatasetStats:
    ...
    Example:
        ...
        ```python
        from hcd.data.utils import HUBDatasetStats
    ...
    def get_json(self, save=False, verbose=False):
        ...
        for split in 'train', 'val', 'test':
            ...
            if self.task == 'classify':
                ...
                from hcd.data import YOLODataset
    ...
    def process_images(self):
        ...
        from hcd.data import YOLODataset  # ClassificationDataset
...
def compress_one_image(f, f_new=None, max_dim=1920, quality=50):
    ...
    Example:
        ```python
        from pathlib import Path
        from hcd.data.utils import compress_one_image
...
def autosplit(path=DATASETS_DIR / 'coco8/images', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Example:
        ```python
        from hcd.data.utils import autosplit
