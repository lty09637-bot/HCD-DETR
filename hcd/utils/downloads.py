...
from hcd.utils import LOGGER, TQDM, checks, clean_url, emojis, is_online, url2file
...
def delete_dsstore(path, files_to_delete=('.DS_Store', '__MACOSX')):
    ...
    Example:
        ```python
        from hcd.utils.downloads import delete_dsstore
...
def zip_directory(directory, compress=True, exclude=('.DS_Store', '__MACOSX'), progress=True):
    ...
    Example:
        ```python
        from hcd.utils.downloads import zip_directory
...
def unzip_file(file, path=None, exclude=('.DS_Store', '__MACOSX'), exist_ok=False, progress=True):
    ...
    Example:
        ```python
        from hcd.utils.downloads import unzip_file
...
def get_google_drive_file_info(link):
    ...
    Example:
        ```python
        from hcd.utils.downloads import get_google_drive_file_info
...
def attempt_download_asset(file, repo='ultralytics/assets', release='v0.0.0'):
    ...
    """
    from hcd.utils import SETTINGS  # scoped for circular import
